...
<div class="bg-white">
    ...
    <div class="max-w-screen-xl mx-auto px-4 md:px-8">
      <div class="items-start justify-between md:flex">
        <div class="max-w-lg">
          <h3 class="text-gray-800 text-xl font-bold sm:text-2xl">Update employees</h3>
        </div>
        ...
        <table class="w-full table-auto text-sm text-left">
          ...
          <tbody class="text-gray-600 divide-y">
            ...
            <tr v-if="filteredTableItems.length === 0">
              <td colspan="5" class="text-center py-4 text-gray-600">No data found</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      filteredTableItems() {
        ...
        return this.tableItems.filter(item => {
          return (
            ...
            item.salary.toLowerCase().includes(this.searchQuery.toLowerCase())
          );
        });
      }
    },
